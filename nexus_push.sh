...
case $1 in
  ...
  test)
    ...
    docker push nexus.teamdigitale.test/tba-kylo-services.8.4:1.1.0
    docker push nexus.teamdigitale.test/tba-kylo-ui.8.4:1.1.0
    docker push nexus.teamdigitale.test/tba-nifi.1.4.0:1.1.1-SNAPSHOT
	;;
  prod)
