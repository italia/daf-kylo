...
package it.gov.daf.nifi.processors.kudu;
...
public abstract class DafAbstractKudu extends AbstractProcessor {

    protected static final String TABLE_ATTRIBUTE_NAME = "kudu_table_name";
    ...
    protected static final PropertyDescriptor INSERT_OPERATION = new PropertyDescriptor.Builder()
        ...
        .allowableValues(DafOperationType.values())
        .defaultValue(DafOperationType.INSERT.toString())
        .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
        .build();
    ...
    protected DafOperationType operationType;
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try {
            ...
            // Getting table name from flowfile using the attribute $TABLE_ATTRIBUTE_NAME
            if ((flowFile != null) && (flowFile.getAttribute(TABLE_ATTRIBUTE_NAME) != null)) {
                tableName = flowFile.getAttribute(TABLE_ATTRIBUTE_NAME);
                kuduTable = this.getKuduTable(kuduClient, tableName);
            }
            session.read(flowFile, (final InputStream rawIn) -> {
                ...
                try (final BufferedInputStream in = new BufferedInputStream(rawIn)) {
                    ...
                    while (record != null) {
                        ...
                        if(operationType == DafOperationType.UPSERT) {
    ...
    protected KuduSession getKuduSession(KuduClient client){
        ...
        if(operationType == DafOperationType.INSERT_IGNORE){
