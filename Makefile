...
activemq:
	...
	docker tag tba-activemq $(REGISTRY)/tba-activemq.5.15.1:1.0.1
...
elasticsearch5:
	...
	docker tag tba-elasticsearch5 $(REGISTRY)/tba-elasticsearch.5.6.4:1.0.1
...
mysql:
	...
	docker tag tba-mysql $(REGISTRY)/tba-mysql.10.3:1.0.1
...
kylo-services:
		...
		docker tag tba-kylo-services $(REGISTRY)/tba-kylo-services.8.4:1.0.1
...
kylo-ui:
		...
		docker tag tba-kylo-ui $(REGISTRY)/tba-kylo-ui.8.4:1.0.1
...
nifi:
		...
		docker tag tba-nifi $(REGISTRY)/tba-nifi.1.4.0:1.0.1
