...
activemq:
	...
	docker tag tba-activemq $(REGISTRY)/tba-activemq.5.15.1:1.0.0-SNAPSHOT
...
elasticsearch5:
	...
	docker tag tba-elasticsearch5 $(REGISTRY)/tba-elasticsearch.5.6.4:1.0.0-SNAPSHOT
...
mysql:
	...
	docker tag tba-mysql $(REGISTRY)/tba-mysql.10.3:1.0.0-SNAPSHOT
